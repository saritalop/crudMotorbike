...
document.getElementById("formulario").addEventListener("submit", function (event) {
  ...
  }else if (!regex.test(nombre_cliente)) {
  ...
  }else if (!regex_num.test(cedula_cliente)) {
  ...
  // else if (!regex_direc.test(direccion_cliente)) {
  ...
  }else if (!regex_tele.test(telefono_cliente)) {
